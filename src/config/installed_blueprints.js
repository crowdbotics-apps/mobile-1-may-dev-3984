export const installed_blueprints = [
  //@BlueprintInsertion
{ name: 'UserProfile3701', human_name: 'User Profile', access_route: 'UserProfile3701'},
{ name: 'EmailAuth3628', human_name: 'Email Auth', access_route: 'EmailAuth3628', icon: 'envelope-o'},
